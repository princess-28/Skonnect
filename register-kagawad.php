        ...
        <div class="main-content">
            ...
            <section style="position: relative;">
                ...
                <form id="myform" method="POST" enctype="multipart/form-data" >
                      ...
                      <input type="hidden" name="apply_position" id="apply_position" value="kagawad">
                      <div class="form-container">
                         <div class="heads">
                            ...
                            <div class="d-text">
                               <div class="app-text">
                                  <h2> APPLICATION FOR SANGGUNIANG KABATAAN KAGAWAD</h2>
                               </div>
                               <br><br>
                               <div class="ins-text">
                                  <p>INSTRUCTIONS:</p>
                               ...
                               <div>
                                  <p>I hereby announce my Candidacy for the position of Sangguniang Kabataan Kagawad <span class="underline editable-area" contenteditable="true" id="barangay"></span>, Municipality of 
