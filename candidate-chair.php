    ...
    <div class="container">
        <nav class="sidenav">
            ...
            <ul class="navi">
                ...
                <li class="active"><a href="candidate.php"><i class="fa-solid fa-users"></i>CANDIDATE</a></li>
        ...
        <div class="main-content">
            ...
            <section>
                <h3>SK CHAIRMAN CANDIDATE LIST</h3>
            ...
            <table id="example">
                ...
                <tbody>
                     ...
                     <?php 
                        ...
                        $query = "SELECT * FROM `apply` WHERE apply_position = 'chairman' AND `apply_status` = 2"; 
                     ...
                     ?>
                        ...
                        <tr>
                            ...
                            <td>                                     
                                        <button type="button" data-id="<?php echo $row["apply_id"]; ?>" data-role="decline" class="btn btn-warning"> <i class="fa-solid fa-close"></i></button>   
...
<!-- Add Modal -->
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', 'button[data-role=decline]', function() {
            ...
            var confirmalert = confirm("Are you sure you want to decline?");
            if (confirmalert == true) {
                $.ajax({
                    url: 'save_register.php',
                    type: 'POST',
